...
class Logger(SummaryWriter):
    ...
    def log_rewards(self, reward_vector):
        ...
        # self.add_scalar(tag='Rewards/reach cuboid', scalar_value=reward_vector[1].mean())
        # self.add_scalar(tag='Rewards/reach cubic', scalar_value=reward_vector[2].mean())
        # self.add_scalar(tag='Rewards/move cuboid', scalar_value=reward_vector[3].mean())
        # self.add_scalar(tag='Rewards/move cubic', scalar_value=reward_vector[4].mean())
